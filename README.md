...
Researched on the scale of phishing URLs and suspicious emails, developing a phishing detector model based on over 800K rows of a dataset with specifically chosen features, all within the AI4ALL Ignite accelerator.
